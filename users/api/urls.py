...
urlpatterns = [
    ...
    path(
        ...
        PresignUploadAPIView.as_view(),
        name="api-users-me-uploads-presign",
    ),
    path(
        "users/me/uploads/<int:upload_id>/",
        MyUploadDeleteAPIView.as_view(),
        name="api-users-me-upload-delete",
    ),
    ...
    path(
        "bookings/hire/<int:performer_id>/",
        CreateHireRequestAPIView.as_view(),
        name="api-bookings-hire",
    ),
    # Payment history — mirrors bookings/views.py performer_payouts + client_payments
    path(
        "bookings/payouts/performer/",
        PerformerPayoutsAPIView.as_view(),
        name="api-bookings-performer-payouts",
    ),
    path(
