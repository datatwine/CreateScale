...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@stagefreedom.org")
...
# CORS — allow Expo web and any other frontends to call the API
...
# Argon2 first (preferred), PBKDF2 kept as fallback for existing passwords
PASSWORD_HASHERS = [
...
if USE_S3:
    ...
    STORAGES = {
        ...
        "staticfiles": {
            "BACKEND": "myproject.storage.ForgivingStaticFilesStorage",
        },
    }
